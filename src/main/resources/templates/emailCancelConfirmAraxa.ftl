                    ...
                    <tr>
                        <td align="center" valign="middle" style="padding-top:30px">
                            <table width="660" cellspacing="0" cellpadding="0" align="center"
                                ...
                                <tr  style="display: flex; justify-content: space-between;padding-top: 5%;margin-bottom: 30px;">
                                        ...
                                        <table>
                                            <tr>
                                                <td align="left" valign="middle"
                                                    style="margin:0;padding:0;font-family:SangBleu Sunrise;font-size:15px;font-weight:700;color: #7F6F50;">
                                                    ${title}
                                                </td>
                                ...
                                <tr>
                                    <td style="padding-left: 40px;padding-right: 40px;padding-top:20px">
                                        <table>
                                            <tr>
                                                <td align="left" valign="middle"
                                                    style="margin:0;padding:0;font-family:SangBleu Sunrise;font-size:12px;text-align:justify;line-height:22px;color: #7F6F50;">
                                                    ${content}
                                                </td>
                                            </tr>
                                            <tr>
                                                </b><td align="left" valign="middle"
                                                        style="margin:0;padding:0;font-family:SangBleu Sunrise;font-size:12px;text-align:justify;line-height:22px;color: #7F6F50;">
                                                    ${inf_refound}
                                                </td>
                                            </tr>
                                            <#list tariffs_descrition as tariff>
                                                <tr>
                                                    <td align="left" valign="middle"
                                                        style="margin:0;padding:0;font-family:SangBleu Sunrise;font-size:12px;text-align:justify;line-height:22px;color: #7F6F50;">
                                                        ${tariff.description}
